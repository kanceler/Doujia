			...
			ProducedBags: []appcore.ProducedBagManifest{
				{
					...
					Members: []appcore.ProducedBagMember{
						{LogicalKey: core.LKCoderBranch, ArtifactVersionID: "av_xxx"},
					},
				},
			},
		},
...
func writeCodeRepairBundle(t *testing.T, inputDir, outputDir string, includeRepairInstruction bool, includePreviousOutputs bool) core.AgentInputBundle {
	...
	inputs := []core.InputArtifact{
		...
		{LogicalKey: core.LKCoderTask, Path: coderTaskPath, ArtifactVersionID: "av_coder_task"},
		{LogicalKey: core.LKModuleContract, Path: moduleContractPath, ArtifactVersionID: "av_module_contract"},
		{LogicalKey: core.LKSeedTests, Path: seedTestsPath, ArtifactVersionID: "av_seed_tests"},
	}
